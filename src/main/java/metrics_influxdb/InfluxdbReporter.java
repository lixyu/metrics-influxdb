...
public class InfluxdbReporter {
	...
	public static class Builder {
		...
		/**
		 * Builds a {@link ScheduledReporter} with the given properties, sending metrics
		 * using the given InfluxDB.
		 *
		...
		public ScheduledReporter build() {
			...
			case V08:
				...
				reporter = (executor == null)
						? new ReporterV08(registry, influxdb, clock, prefix, rateUnit, durationUnit, filter,
								skipIdleMetrics)
						: new ReporterV08(registry, influxdb, clock, prefix, rateUnit, durationUnit, filter,
								skipIdleMetrics, executor);
				break;
			default:
		...
		/**
		 * Registers the given key/value as a default tag for the generated
		 * measurements.
		 * 
		 * @param tagKey
		 *            the key to register, cannot be null or empty
		 * @param tagValue
		 *            the value to register against the given key, cannot be null or
		 *            empty
		 */
