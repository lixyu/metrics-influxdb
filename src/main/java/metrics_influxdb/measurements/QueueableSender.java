...
public class QueueableSender extends AbstractSender {
	...
	public void send(Measure m) {
		...
		if (measures.size() == queueSize) {
			// we have already reached the maximumn number of measure that can be sent in
			// one shot
	 ...
	 * 
	 * @param measuresToSend
	 *            the collection of measure to be sent
	 * @return true if the measures have been sent and can be discarded, false
	 *         otherwise
	 */
